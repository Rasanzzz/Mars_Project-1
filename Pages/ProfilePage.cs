...
namespace Mars_Project.Pages
{
    public class ProfilePage 
    {
        ...
        public void GetName(IWebDriver driver)
        {
            ...
            Assert.That(Title.Text == "James Kai", "Name has not been added");
        ...
        { 
            ...
            AddText.Clear();
            AddText.Clear();
            AddText.SendKeys("Welcome to my Profile");
        ...
        public void GetDescription(IWebDriver driver)
        {
            ...
            Assert.That(Description.Text == "Welcome to my Profile", "Description has not added");
        ...
        public void GetSkill(IWebDriver driver)
        {
            ...
            Assert.That(newSkill.Text == "Selenium", "skill has not added");
        ...
        public void GetCertificationDetails(IWebDriver driver)
        {
            ...
            Assert.That(CheckYear.Text == "2023", "year has not added");
